...
--
-- replace into SHOP_ORDER_ITEM (id, date, price, quantity, seller_ad_id, shop_order_id) VALUES (1, "2022-08-08", 1.0, 2, 2, 1);
-- replace into SHOP_ORDER_ITEM (id, date, price, quantity, seller_ad_id, shop_order_id) VALUES (2, "2022-08-08", 8.0, 5, 1, 1);
--
--
